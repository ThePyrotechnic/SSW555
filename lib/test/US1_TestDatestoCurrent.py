...
_families = [
    Family('F1', husband = '1', wife = '4', married = datetime(1973, 4, 11, 0, 0)),
    Family('F2', husband = '3', wife = '2', married = datetime(2000, 10, 31, 0, 0), divorced = datetime.datetime(2007, 12, 25, 0, 0))
]
correct_dates = Tree()
...
_families2 = [
    Family('F1', married = datetime(2015, 1, 18, 0, 0)),
