...
_individuals = [
    ...
    Individual('3', name='John /Doe/', sex='F', birthday=datetime(day=2, month=3, year=1962)),
    ...
    Individual('7', name='Ken /White/', sex='F', birthday=datetime(day=30, month=1, year=1946)),
    Individual('8', name='Ana /White/', sex='M', birthday=datetime(day=3, month=5, year=1940))   
]
